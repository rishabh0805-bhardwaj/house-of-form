...
export const MaterialAtelierPage: React.FC = () => {
  const { veloraAtelier, materials, finishes, setIsReservationModalOpen, setCurrentView, settings } = useStore();
  ...
  return (
    <div className="bg-[#FBF9F5] text-[#191816]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl space-y-6">
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-4">
              ...
              <button
                onClick={() => setCurrentView('digital-swatches')}
              ...
              >
                ...
                <span>Explore Swatch Passport</span>
              </button>
            </div>
          </div>
        </div>
      ...
      {/* The Philosophy: Why This Is NOT a "Free Sample Kit" */}
      ...
      {/* The Physical Kit Specification */}
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            {/* Packaging Features */}
            <div className="space-y-3 text-xs text-[#2C2926]">
      ...
      <section className="bg-[#F4EFEB] py-16 border-t border-[#E6DFD5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {veloraAtelier.paletteSuggestions.map((pal) => (
              <div key={pal.id} className="bg-white border border-[#D1C7BB] overflow-hidden flex flex-col">
                <div className="aspect-[16/10] overflow-hidden">
                  <img src={pal.image} alt={pal.title} className="w-full h-full object-cover" />
                </div>
